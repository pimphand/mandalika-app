<div>
    <div class="container">
        ...
        <div class="element-heading d-flex justify-content-between align-items-center mb-2">
            ...
            <div>
                <button class="btn btn-sm btn-outline-primary" wire:click="resetFilters" data-bs-toggle="modal"
                        data-bs-target="#addnewcontact">Semua
                </button>
                <button class="btn btn-sm btn-outline-success" wire:click="$set('isBlacklist', 'aktif')"
                        data-bs-toggle="modal" data-bs-target="#addnewcontact">Aktif
                </button>
                <button class="btn btn-sm btn-outline-dark" wire:click="$set('isBlacklist', 'blacklist')"
                        data-bs-toggle="modal" data-bs-target="#addnewcontact">Blacklist
                </button>
            </div>
            <div>
