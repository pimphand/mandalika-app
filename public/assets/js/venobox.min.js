! function(e, t) {
     ...
     */
    let e, t, o, n, s, i, a, r, l, d, c, v, u, b, p, g, f, m, y, x, h, L, w, k, S, C, A, E, q, P, M, T, j, H, O, z, I, V;
    let B, N = 0,
        D = 0,
        Q = 0,
        X = !1,
    ...
    function ie() {
        var e;
        if (e = x, Y.innerHTML = e, g = Y.querySelectorAll("img"), g.length) {
            let e = 0;
            W(g, (function(t) {
                let o = t.src;
                const n = new Image;
    ...
    function ae(e) {
        if (!y) {
            ...
            a.style.transition = "margin " + t + "ms ease-out, opacity " + t + "ms ease-out", N = D = "touchstart" === e.type ? e.touches[0].pageX : e.pageX, T = v = "touchstart" === e.type ? e.touches[0].pageY : e.pageY, X = !0
        }
    }
    ...
    function re(e) {
        if (X) {
            ...
            let e = r,
                t = !1;
            Q = D - N, Q < 0 && L && (e = j, t = !0), Q > 0 && w && (e = H, t = !0), Math.abs(Q) >= 50 && t ? ue(e) : (a.style.marginLeft = 0, a.style.opacity = 1)
        }
    }

    function le(e) {
        if (X && !y) {
            D = "touchmove" === e.type ? e.touches[0].pageX : e.pageX, v = "touchmove" === e.type ? e.touches[0].pageY : e.pageY, d = D - N, c = v - T;
            let t = Math.abs(d);
    ...
    function de(e) {
    if (!e) return !1;
    z = e.dataset.gall, h = e.settings.numeration, f = e.settings.infinigall, o.innerHTML = "";
    let s = e.dataset.vbtype;
    e.settings.share && "iframe" !== s && "inline" !== s && "ajax" !== s && function(e) {
        if (navigator.canShare) {
            const t = { url: window.location.href };
    ...
    function ve() {
        ...
        switch (r.dataset.vbtype) {
            ...
            default:
                ! function(e) {
                    R.onload = function() {
                        x = '<div class="vbox-child"><img loading="lazy"src="' + e + '"></div>', a.classList.remove("vbox-loading"), ne("animated")
                    }, R.src = e
                }(q)
        }
        var e, t
    ...
    function ue(e) {
        ...
        a.classList.add("vbox-animated", "vbox-loading"), B = a.cloneNode(!1), B.classList.add("cloned"), B.classList.remove("swipe-left", "swipe-right"), B.style.opacity = 0, B.style.marginLeft = "0", B.style.marginRight = "0";
        const n = a;
        i.append(B), a = B, a.classList.remove("cloned"), de(e), _({
